EC2_TYPE=c5.xlarge
IMAGE_ID=ami-0ac43988dfd31ab9a # amazon linux
KEY_NAME=ibc
...
read IP_ADDRESS
ssh -i "key/${IBC}.pem" ec2-user@$IP_ADDRESS "sudo yum install git -y; git clone https://github.com/heliaxdev/ibc-setup"